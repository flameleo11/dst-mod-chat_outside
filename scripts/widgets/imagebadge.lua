...
this.ver = GetTime()
--[[
modget("chat_outside").import("widgets/imagebadge");
...
this.trace = function (...)
  ...
  local msg = tjoin(arr, ",")
  TheNet:Say(msg)
  print("..................this.trace...............", msg)
end

this._ctor = _f(function(self, prefab, emotename, emote, image, text, color)
	Widget._ctor(self, "ImageBadge-"..emotename)
	self.isFE = false
...
local ImageBadge = this.ImageBadge
if not (ImageBadge) then
	ImageBadge = Class(Widget, function(self, prefab, emotename, emote, image, text, color)
		this._ctor(self, prefab, emotename, emote, image, text, color)
	end)
	this.ImageBadge = ImageBadge
end

function ImageBadge:RefreshSkins()
